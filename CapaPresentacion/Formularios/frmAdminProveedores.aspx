<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/frmMenu.Master" AutoEventWireup="true" CodeBehind="frmAdminProveedores.aspx.cs" Inherits="SistemaFarmaciaWeb.Formularios.frmAdminProveedores" %>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label>CODIGO</label>
                            <asp:TextBox ID="txtIdProveedor" runat="server" placeholder="Digite el codigo..." CssClass="form-control" MaxLength="8" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;"> </asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtPrecio" runat="server" placeholder="Digite su telefono..." CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>EMAIL</label>
                            <asp:TextBox ID="txtEmail" runat="server" placeholder="Digite su email..." CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label>Seleccione el Proveedor a Editar</label>
                        </div>
                        <div class="form-group">
