        ...
        <form id="form1" runat="server">
            <div class="body bg-gray">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control" placeholder="Ingrese su cedula..." Text="admin"></asp:TextBox>
                </div>

                <div class="form-group">
                    <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" placeholder="Ingrese su contraseña" Text="admin"></asp:TextBox>
                </div>
